...
public class FlightIdMissingExceptionTest {
	

	
	//测试策略：
	//调用非法文本文件src/exception/testFiles/Flight15.txt 存在航班ID缺失的错误
	//观察是否会抛出FlightIdMissingExceptionTest异常 （捕捉异常 观察相关信息）
	...
	public void test() {
		...
		try (Scanner fileScan = new Scanner(new File("src/exception/testFiles/Flight15.txt"))){
	...
	{
		assertEquals("Flight:2020-01-16,",e.getMessage());
	}
}
}
