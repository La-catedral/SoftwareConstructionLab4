...
public class PlaneIdFormatExceptionTest {
	
	//测试策略：
	//调用非法文本文件src/exception/testFiles/Flight10.txt 飞机ID不合法的错误
	//观察是否会抛出PlaneIdFormatExceptionTest异常 （捕捉异常 观察相关信息）
	...
	public void test() {
		...
		try(Scanner fileScan = new Scanner(new File("src/exception/testFiles/Flight10.txt")) ) {
	...
	{
		assertEquals("C6967",e.getMessage());
	}
}
