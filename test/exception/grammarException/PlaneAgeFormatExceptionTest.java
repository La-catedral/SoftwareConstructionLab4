...
public class PlaneAgeFormatExceptionTest {

	
	//测试策略：
	//调用非法文本文件src/exception/testFiles/Flight14.txt 飞机机龄不合法的错误
	//观察是否会抛出PlaneAgeFormatExceptionTest异常 （捕捉异常 观察相关信息）
	...
	public void test() {
		...
		try (Scanner fileScan = new Scanner(new File("src/exception/testFiles/Flight14.txt"))){
