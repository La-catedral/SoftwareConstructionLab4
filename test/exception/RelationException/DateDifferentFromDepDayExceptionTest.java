...
public class DateDifferentFromDepDayExceptionTest {


	//测试策略：
	//调用非法文本文件src/exception/testFiles/Flight8.txt 即航班日期与起飞时间不同
	//观察是否会抛出DateDifferentFromDepDayException异常 （捕捉异常 观察相关信息）
	...
	public void test() {
		...
		try {
			Scanner fileScan = new Scanner(new File("src/exception/testFiles/Flight8.txt"));
	...
	{
		assertEquals("2020-01-17",e.getMessage());
	}
}
